...
import { ingredients, ingredientTags, tags, recipes, recipeIngredients, units, recipeTags, recipeVersions, users, shoppingLists, shoppingListIngredients, userRecipes } from "./schema";
...
export const shoppingListIngredientsRelations = relations(shoppingListIngredients, ({one}) => ({
